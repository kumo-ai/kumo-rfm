"""Script to generate the context table for the relbench datasets.

Steps to run this:
python generate_context_table.py --dataset=<dataset> --task=<task> --splits=<splits>

Ex:
python generate_context_table.py --dataset=rel-avito --task=ad-ctr --splits=test,val,train
"""
import argparse
